...
def on_data(context):
    ...
    try:
        ...
        BT_total = np.nan_to_num(BT_[[29 + i * 30 for i in range(50)]])
    ...
    def __init__(self):
        ...
        if not self.__first_init:
            ...
            for i in range(len(self.targetlist)):
                print(i)
                self.temp = fdmt.indicator.indi_growth(target_list=[self.targetlist[i]], report_type=['Q1'], begin_date='2016-01-01',
                                              end_date='2016-06-01', field=('basic_eps_yoy','oper_profit_yoy'))
                try:
...
if __name__ == '__main__':
    ...
    targetlist = ['SSE.601398','SSE.601179']
